...
from GPS_PSD_func import (QinDenton_period, load_data, data_period, data_from_gps, 
...
from REPT_PSD_func import (process_l3_data, average_fluxes_by_pitch_angle, find_mag)
...
### Average fluxes with the same pitch angles (assume symmetry about 90 degrees) ###
    for satellite, sat_data in REPT_data.items():
        print(f"Averaging Fluxes with same PA for satellite {satellite}...")
        REPT_data[satellite] = average_fluxes_by_pitch_angle(sat_data, satellite)
